...
@pytest.mark.parametrize("name", [
    ...
    "prefetch.evaluation.cache.collect",
    "prefetch.evaluation.cache.simulate",
...
def test_cli_help(name, monkeypatch, capsys):
    if name not in {"prefetch.datasets.prepare", "prefetch.evaluation.plot", "prefetch.evaluation.cache.simulate"}:
